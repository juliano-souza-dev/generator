(() => {
  ...
  async function applyMusicContext() {
    try {
      ...
      if (hero) hero.textContent = 'A Groq gera somente TTS dos cards aprovados. O Generator cria o JSON Music do HUB, Anki e o pacote final.';
    } catch (_) {}
  }
