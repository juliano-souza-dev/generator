...
def download_video(url: str, project_directory: str | Path, *, progress: ProgressCallback | None = None, preferred_player_client: str | None = None, highest_quality: bool = False) -> Path:
    _ensure_ytdlp()
    import yt_dlp
